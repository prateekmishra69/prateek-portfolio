...
const TalkingAvatar: React.FC<TalkingAvatarProps> = ({ isSpeaking, imageUrl }) => {
  ...
  return (
    <div className="relative flex items-center justify-center w-full max-w-[320px] lg:max-w-[400px] aspect-square mx-auto">
      ...
      >
        ...
        >
          {/* We use standard img to allow any path safely without Next Image domain configs initially */}
          <img 
            src={imageUrl} 
            alt="Prateek Mishra"
            ...
            onError={(e) => {
              ...
              (e.target as HTMLImageElement).src = 'https://ui-avatars.com/api/?name=Prateek+Mishra&size=400&background=random';
            }}
          />
